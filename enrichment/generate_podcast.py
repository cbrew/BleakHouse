...
# Prompt templates moved to enrichment/llm/generation_prompts.py
# (2026-05-18, BleakHouse-mz2g).
from enrichment.llm.generation_prompts import (  # noqa: E402
    QUOTE_SOURCING_V2 as _QUOTE_SOURCING_V2,
    SEGMENT_LENGTH_LONG as _SEGMENT_LENGTH_LONG,
    SEGMENT_LENGTH_SHORT as _SEGMENT_LENGTH_SHORT,
    SYSTEM_PROMPT,
)
