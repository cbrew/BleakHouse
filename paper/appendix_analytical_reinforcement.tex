...
Dickens's prose is inherently more memorisable than Oliphant's,
regardless of secondary discussion.  We address this by examining
within-author gradients, which hold prose style constant.

\begin{table}[ht]
\centering
\small
\caption{Within-author nop verification gradients.  All novels by the
same author share the same prose style; differences must reflect
something other than stylistic memorisability.}
...
admired, is the least widely assigned.  Same author, same prose style,
different critical prominence, different quote fidelity.

\textbf{Eliot} (3 novels): Middlemarch (57\%) $>$ Mill on the Floss
(37\%) $>$ Daniel Deronda (30\%).  Middlemarch is far more widely
taught and discussed than Daniel Deronda.

\textbf{Gaskell} (2 novels): Cranford (33\%) $\gg$ North and South
(2\%).  This is the most striking within-author contrast: despite
being shorter, less famous in popular culture, and by the same author,
Cranford dramatically outperforms.  North and South's modern popularity
is adaptation-driven; Cranford's, though also boosted by a BBC
adaptation, draws on a longer history of classroom use.
