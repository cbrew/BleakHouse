...
Fish's thesis at scale.  When two radically different passage-selection
strategies produce convergent discussions, the dominant variable is the
interpretive community (the expert panel), not the text.  A Marxist
reading of \textit{Cranford} and a Marxist reading of \textit{Hard
Times} differ in their textual evidence but not in their analytical
character.  The reader makes the reading.
