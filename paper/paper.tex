...
does not route to experts, at zero cost---discarding a passage is
free.  The OR-Tools \texttt{SimpleMinCostFlow} solver requires exact
...
\caption{Per-dimension min-cost flow graph.  Each eligible passage is
  ...
  \textbf{Passage$\to$null} arcs (dashed, cost${}={}$0) let the
  solver discard passages freely; the null sink absorbs all supply
  not routed to experts.  OR-Tools requires exact balance: total
