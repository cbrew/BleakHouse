...
\end{tikzpicture}
% TODO UPDATE AND CHECK: Jaccard number from old demands.
...
% TODO UPDATE AND CHECK: episode counts will change with new demands/architecture.
...
% TODO UPDATE AND CHECK: all manipulability numbers are from old demands (1-3).
% Re-run peaked and high-arc experiments with new demands (6-12) and update.
...
\begin{table}[t]
% TODO UPDATE AND CHECK: token totals will change with new run counts.
...
% TODO UPDATE AND CHECK: all numbers in Table 3 are from old demands/architecture.
...
\label{sec:grounding}
% TODO UPDATE AND CHECK: quote verification rates from old demands/architecture.
...
% TODO UPDATE AND CHECK: Jaccard and convergence numbers from old demands/architecture.
...
% TODO UPDATE AND CHECK: identity metrics and airtime table from old demands/architecture.
...
% TODO UPDATE AND CHECK: conversational metrics from old demands/architecture.
...
% TODO UPDATE AND CHECK: Jaccard and percentage numbers from old demands/architecture.
