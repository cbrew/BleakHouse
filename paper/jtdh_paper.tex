...
bring.  Our convergence paradox extends this: not only different
...
different interpretive possibilities---even as the convergence paradox
...
metrics are not literary judgements.  But the convergence paradox, the
...
\newpage
\input{appendix_analytical_reinforcement}
